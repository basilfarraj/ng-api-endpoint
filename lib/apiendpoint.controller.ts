module app.Common.ApiEndpointModule {
    ...
    export class ExampleController {
        ...
        useGet = (): any=> {
            this.$service.useGet(app.Common.ApiEndpointModule.Variables.URL.Test, { param: this.param });
        }
        useSecuredGet = (): any=> {
            this.$service.useSecuredGet(app.Common.ApiEndpointModule.Variables.URL.Test, { param: this.param });
        }
